  ...
  const StepBar = () => (
    <div style={{ position:'sticky', top:0, zIndex:40, background:'rgba(0,0,0,0.9)', backdropFilter:'blur(20px)', borderBottom:'1px solid rgba(255,255,255,0.05)', padding:'12px 16px 10px' }}>
      ...
      <div style={{ display:'flex', gap:'5px', marginBottom:'5px' }}>
        {[1,2,3].map(i => (
          <div key={i} style={{ flex:1, height:'3px', borderRadius:'2px', background:'#1a1a1a', overflow:'hidden' }}>
            <div style={{ height:'100%', borderRadius:'2px', background: i < currentStep ? '#22c55e' : i === currentStep ? '#3b82f6' : 'transparent', transition:'background 0.4s, transform 0.4s', transform: i <= currentStep ? 'scaleX(1)' : 'scaleX(0)', transformOrigin:'left' }} />
          </div>
        ))}
      </div>
      <div style={{ display:'flex' }}>
        {['基本情報','作業詳細','産廃・スクラップ'].map((l,i) => (
          <div key={i} style={{ flex:1, textAlign:'center', fontSize:'9px', fontWeight:600, textTransform:'uppercase', letterSpacing:'0.05em', color: i+1 < currentStep ? '#22c55e' : i+1 === currentStep ? '#60a5fa' : '#374151', transition:'color 0.3s' }}>{l}</div>
        ))}
      </div>
    </div>
  );
    ...
    <div style={{ background:'#000', minHeight:'100vh' }}>
      ...
      {currentStep === 1 && (
        <div>
          <div style={{ marginBottom:'22px' }}>
            <div style={secLabel}>基本情報<span style={{ flex:1, height:'1px', background:'#0f0f0f', marginLeft:'8px' }} /></div>
            <div style={g2}>
          ...
          <div style={{ marginBottom:'22px' }}>
            <div style={secLabel}>施工情報<span style={{ flex:1, height:'1px', background:'#0f0f0f', marginLeft:'8px' }} /></div>
      ...
      {currentStep === 2 && (
        <div>
          {/* 自社人工 */}
          <div style={{ marginBottom:'22px' }}>
            <div style={secLabel}>自社人工<span style={{ flex:1, height:'1px', background:'#0f0f0f', marginLeft:'8px' }} /></div>
          ...
          {/* 外注人工 */}
          <div style={{ marginBottom:'22px' }}>
            <div style={secLabel}>外注人工<span style={{ flex:1, height:'1px', background:'#0f0f0f', marginLeft:'8px' }} /></div>
          ...
          {/* 車両 */}
          <div style={{ marginBottom:'22px' }}>
            <div style={secLabel}>車両<span style={{ flex:1, height:'1px', background:'#0f0f0f', marginLeft:'8px' }} /></div>
          ...
          {/* 重機 */}
          <div style={{ marginBottom:'22px' }}>
            <div style={secLabel}>重機<span style={{ flex:1, height:'1px', background:'#0f0f0f', marginLeft:'8px' }} /></div>
      ...
      {currentStep === 3 && (
        <div>
          {/* 産廃 */}
          <div style={{ marginBottom:'22px' }}>
            <div style={secLabel}>産廃処分費<span style={{ flex:1, height:'1px', background:'#0f0f0f', marginLeft:'8px' }} /></div>
            {wasteItems.length > 0 && (
              <div style={listWrap}>
                {wasteItems.map((w,i) => (
          ...
          {/* スクラップ */}
          <div style={{ marginBottom:'22px' }}>
            <div style={secLabel}>スクラップ売上<span style={{ flex:1, height:'1px', background:'#0f0f0f', marginLeft:'8px' }} /></div>
            {scrapItems.length > 0 && (
              <div style={listWrap}>
                {scrapItems.map((s,i) => (
